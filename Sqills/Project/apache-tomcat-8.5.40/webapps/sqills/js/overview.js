	        ...
	        $.getJSON("/sqills/api/reservations/overview", function (data) {
	            $(data).each(function () {
	                ...
	                if (this.startTime !== 0 && this.endTime !== 0) {
	                    ...
	                    if (this.visible) {
	                    	information += "<hr><h4>" + this.name + "</h4>";
	                    	information += "<h5>" + this.user.firstName + " " + this.user.lastName;
	                    	information += "<br>and " + (this.numberOfAttendees - 1) + " others" + "</h5>";
	                    } else {
